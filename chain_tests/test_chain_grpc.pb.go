...
func (c *testServiceClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/chaintests.TestService/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testServiceClient) SayGoodbye(ctx context.Context, in *GoodbyeRequest, opts ...grpc.CallOption) (*GoodbyeReply, error) {
	...
	err := c.cc.Invoke(ctx, "/chaintests.TestService/SayGoodbye", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TestService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chaintests.TestService/SayHello",
	}
...
func _TestService_SayGoodbye_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chaintests.TestService/SayGoodbye",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var TestService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "chaintests.TestService",
